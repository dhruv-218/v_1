flowchart TD
    ...
    subgraph Programming & Tools
        ...
        style B1,B2,B3,B4,B5 fill:#8dd3c7
    ...
    subgraph Certifications & Seminars
        D --> D1[AI/ML for Geodata Analysis (ISRO-IIRS)]
        D --> D2[Python for Data Science (NPTEL)]
        D --> D3[Data Science & Business Intelligence]
        D --> D4[Quantum Computing Seminar]

        style D1,D2,D3,D4 fill:#f0ffff
    end
