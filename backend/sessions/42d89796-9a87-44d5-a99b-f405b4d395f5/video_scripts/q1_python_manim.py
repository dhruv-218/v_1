...
class Q1_Python(Scene):
    def construct(self):
        ...
        q_text = Text("Which of the following is a key skill that aligns with your proficiency in Pytho", font_size=22, color=WHITE).next_to(q_label, DOWN, buff=0.5)
        ...
        a_text = Text("B", font_size=28, color=GREEN)
        ...
        explanation = VGroup(
            Text("You demonstrate strong proficiency in both", font_size=20, color=WHITE),
            Text("Python and SQL, as evidenced by your", font_size=20, color=WHITE),
            Text("certifications and experience with Python for", font_size=20, color=WHITE),
            Text("Data Science. This aligns with the MCQ", font_size=20, color=WHITE),
