...
class Q2_Whatisthefirstrule(Scene):
    def construct(self):
        # ── Title card ──
        title = Text("What is the first rule used in Kirchhoff", font_size=40, color=BLUE, weight=BOLD)
        ...
        q_text = Text("What is the first rule used in Kirchhoff's laws?", font_size=22, color=WHITE).next_to(q_label, DOWN, buff=0.5)
        ...
        explanation = VGroup(
            Text("The first rule of Kirchhoff is used at every", font_size=20, color=WHITE),
            Text("junction to assign the unknown currents. This", font_size=20, color=WHITE),
            Text("allows the determination of three unknowns", font_size=20, color=WHITE),
            Text("(I1, I2, I3) by applying the second rule of", font_size=20, color=WHITE),
